...
class cycleControl{
    ...
    int currentStage = 0;
    cycleControl(movementCycles activeCycle, rampLeg AlegR, rampLeg BlegR, rampLeg ClegR, rampLeg DlegR, kinematics AlegK,
    kinematics BlegK, kinematics ClegK, kinematics DlegK) : activeCycle(activeCycle), AlegR(AlegR), BlegR(BlegR), ClegR(ClegR),
    DlegR(DlegR), AlegK(AlegK), BlegK(BlegK), ClegK(ClegK), DlegK(DlegK) {}
